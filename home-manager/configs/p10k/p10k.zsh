# Generated by Powerlevel10k configuration wizard on 2021-07-14 at 11:44 UTC.
...
# dotted, no frame, dark-ornaments, sparse, few icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#83c092'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#83c092'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  #typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=39
  #typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#83c092'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%100F'   # green foreground
